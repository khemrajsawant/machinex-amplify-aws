        ...
        <Stack>
          ...
          <Stack>
            <FormComponent
              ...
              enableButton={true}
              primarykey={{ JWO_No: nextJobWorkOrderID }}
              prefilled={{ JWO_No: nextJobWorkOrderID }}
              onChange={onChangeHandler}
            />
            <DataGridCustomComponent
              isMaster={props.isMaster}
              data={tableJobWorkOrder}
              pathname={location.pathname}
              columns={JOB_WORK_ORDER.columnsData}
              formName={JOB_WORK_ORDER.metaData[0].sheetname}
        ...
        {/* <Stack>
          ...
          <Stack>
            {/* <FormComponent
              ...
              items={items.JOB_WORK_ORDER_DETAILS}
              direction="row"
              headerValue="MACHINE_MASTER"
