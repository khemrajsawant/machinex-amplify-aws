...
const GeneralWorkMaster = (props) => {
    ...
    const { GENERAL_WORK_LIST: GENERAL_WORK_LIST } = useSelector((state) => state.master.APP_DATA);
    // states
    ...
    const tableGeneralWorkList = useSelector((state) => state.master.GENERAL_WORK_LIST);
    ...
    const preparePostData = () => {
        const prepdata = {
            GENERAL_WORK_LIST: tableGeneralWorkList.filter((c) => !(c.isServer && !c.isDeleted && !c.isNew && !c.isModified)),
        };
        let temp1 = {
            GENERAL_WORK_LIST: prepdata.GENERAL_WORK_LIST.filter((c) => !(!c.isServer && c.isDeleted && c.isNew && !c.isModified)),
        };
        let temp2 = {
            GENERAL_WORK_LIST: temp1.GENERAL_WORK_LIST.filter((c) => !(!c.isServer && c.isDeleted && !c.isNew && c.isModified)),
        };
        ////console.log(temp2);
        return temp2;
    };
