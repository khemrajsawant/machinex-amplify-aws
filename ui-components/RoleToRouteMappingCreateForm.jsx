...
import { createRoleToRouteMapping } from "./graphql/mutations";
...
export default function RoleToRouteMappingCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setCurrentRoleValue("");
    setAllowed_Routes(initialValues.Allowed_Routes);
    setCurrentAllowed_RoutesValue("");
    setAllowed_Subroutes_Masters(initialValues.Allowed_Subroutes_Masters);
    setCurrentAllowed_Subroutes_MastersValue("");
    setAllowed_Subroutes_Transactions(
      initialValues.Allowed_Subroutes_Transactions
    );
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createRoleToRouteMapping.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "RoleToRouteMappingCreateForm")}
      {...rest}
    >
      <ArrayField
