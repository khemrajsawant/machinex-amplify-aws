...
import { createItemMaster } from "./graphql/mutations";
const client = generateClient();
export default function ItemMasterCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setItem_Group(initialValues.Item_Group);
    setUOM(initialValues.UOM);
    setItem_Material(initialValues.Item_Material);
    setRough_Weight(initialValues.Rough_Weight);
    setFinish_Weight(initialValues.Finish_Weight);
    setScrap_Value(initialValues.Scrap_Value);
    setMaterial_Handling_Charges(initialValues.Material_Handling_Charges);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createItemMaster.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "ItemMasterCreateForm")}
      {...rest}
    >
      <TextField
        label="Id"
