...
import { createRejectionReportDetails } from "./graphql/mutations";
const client = generateClient();
export default function RejectionReportDetailsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setWork_Order_No(initialValues.Work_Order_No);
    setDrawing_No(initialValues.Drawing_No);
    setOpn_Details(initialValues.Opn_Details);
    setQuantity(initialValues.Quantity);
    setMat_Cost(initialValues.Mat_Cost);
    setRej_Details(initialValues.Rej_Details);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createRejectionReportDetails.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "RejectionReportDetailsCreateForm")}
      {...rest}
    >
      <TextField
        label="Id"
