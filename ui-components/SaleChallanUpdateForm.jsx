...
import { getSaleChallan } from "./graphql/queries";
import { updateSaleChallan } from "./graphql/mutations";
const client = generateClient();
export default function SaleChallanUpdateForm(props) {
  const {
    id: idProp,
    saleChallan: saleChallanModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = saleChallanRecord
      ? { ...initialValues, ...saleChallanRecord }
      : initialValues;
  ...
  const [saleChallanRecord, setSaleChallanRecord] =
    React.useState(saleChallanModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? (
            await client.graphql({
              query: getSaleChallan.replaceAll("__typename", ""),
              variables: { id: idProp },
            })
          )?.data?.getSaleChallan
        : saleChallanModelProp;
      setSaleChallanRecord(record);
    };
    queryData();
  }, [idProp, saleChallanModelProp]);
  React.useEffect(resetStateValues, [saleChallanRecord]);
  const validations = {
    ID: [],
    Challan_No: [],
    Date: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: updateSaleChallan.replaceAll("__typename", ""),
            variables: {
              input: {
                id: saleChallanRecord.id,
                ...modelFields,
              },
            },
          });
      ...
      {...getOverrideProps(overrides, "SaleChallanUpdateForm")}
      {...rest}
    >
      <TextField
        label="Id"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || saleChallanModelProp)}
