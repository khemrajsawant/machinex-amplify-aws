...
import { createBillOfProces } from "./graphql/mutations";
const client = generateClient();
export default function BillOfProcesCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setOperation_float(initialValues.Operation_float);
    setWorkstation(initialValues.Workstation);
    setOpn_Name(initialValues.Opn_Name);
    setOperation_Description(initialValues.Operation_Description);
    setTime_Min(initialValues.Time_Min);
    setCost(initialValues.Cost);
    setIs_Scrap_Applicable(initialValues.Is_Scrap_Applicable);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createBillOfProces.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "BillOfProcesCreateForm")}
      {...rest}
    >
      <TextField
        label="Id"
