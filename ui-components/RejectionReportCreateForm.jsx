...
import { createRejectionReport } from "./graphql/mutations";
const client = generateClient();
export default function RejectionReportCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createRejectionReport.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "RejectionReportCreateForm")}
      {...rest}
    >
      <TextField
        label="Id"
