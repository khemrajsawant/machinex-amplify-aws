...
import { createSaleChallanDetails } from "./graphql/mutations";
const client = generateClient();
export default function SaleChallanDetailsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setChallan_No(initialValues.Challan_No);
    setChallan_Sr_No(initialValues.Challan_Sr_No);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createSaleChallanDetails.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "SaleChallanDetailsCreateForm")}
      {...rest}
    >
      <TextField
        label="Id"
