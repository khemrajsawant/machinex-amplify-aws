...
import { createEmployeeMaster } from "./graphql/mutations";
const client = generateClient();
export default function EmployeeMasterCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setJoining_Date(initialValues.Joining_Date);
    ...
    setMobile_No(initialValues.Mobile_No);
    setEmail(initialValues.Email);
    setAadhar_No(initialValues.Aadhar_No);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createEmployeeMaster.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "EmployeeMasterCreateForm")}
      {...rest}
    >
      <TextField
        label="Id"
