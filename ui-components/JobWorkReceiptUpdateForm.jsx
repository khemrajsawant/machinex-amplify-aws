...
import { getJobWorkReceipt } from "./graphql/queries";
import { updateJobWorkReceipt } from "./graphql/mutations";
const client = generateClient();
export default function JobWorkReceiptUpdateForm(props) {
  const {
    id: idProp,
    jobWorkReceipt: jobWorkReceiptModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = jobWorkReceiptRecord
      ? { ...initialValues, ...jobWorkReceiptRecord }
      : initialValues;
  ...
  const [jobWorkReceiptRecord, setJobWorkReceiptRecord] = React.useState(
    jobWorkReceiptModelProp
  );
  React.useEffect(() => {
      ...
      const record = idProp
        ? (
            await client.graphql({
              query: getJobWorkReceipt.replaceAll("__typename", ""),
              variables: { id: idProp },
            })
          )?.data?.getJobWorkReceipt
        : jobWorkReceiptModelProp;
      setJobWorkReceiptRecord(record);
    };
    queryData();
  }, [idProp, jobWorkReceiptModelProp]);
  React.useEffect(resetStateValues, [jobWorkReceiptRecord]);
  const validations = {
    ID: [],
    Inword_No: [],
    Date: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: updateJobWorkReceipt.replaceAll("__typename", ""),
            variables: {
              input: {
                id: jobWorkReceiptRecord.id,
                ...modelFields,
              },
            },
          });
      ...
      {...getOverrideProps(overrides, "JobWorkReceiptUpdateForm")}
      {...rest}
    >
      <TextField
        label="Id"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || jobWorkReceiptModelProp)}
