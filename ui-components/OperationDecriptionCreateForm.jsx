...
import { createOperationDecription } from "./graphql/mutations";
const client = generateClient();
export default function OperationDecriptionCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setOpn_Desc(initialValues.Opn_Desc);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createOperationDecription.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "OperationDecriptionCreateForm")}
      {...rest}
    >
      <TextField
        label="Id"
