...
import { createJobWorkOrderOperationDetails } from "./graphql/mutations";
const client = generateClient();
export default function JobWorkOrderOperationDetailsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createJobWorkOrderOperationDetails.replaceAll(
              "__typename",
              ""
            ),
            variables: {
      ...
      {...getOverrideProps(overrides, "JobWorkOrderOperationDetailsCreateForm")}
      {...rest}
    >
      <TextField
        label="Id"
