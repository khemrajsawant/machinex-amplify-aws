...
import { createGeneralWorkList } from "./graphql/mutations";
const client = generateClient();
export default function GeneralWorkListCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setGeneral_Work(initialValues.General_Work);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createGeneralWorkList.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "GeneralWorkListCreateForm")}
      {...rest}
    >
      <TextField
        label="Id"
