...
import { createBankDetails } from "./graphql/mutations";
const client = generateClient();
export default function BankDetailsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setAccount_No(initialValues.Account_No);
    setIFSC_Code(initialValues.IFSC_Code);
    setBank_Name(initialValues.Bank_Name);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createBankDetails.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "BankDetailsCreateForm")}
      {...rest}
    >
      <TextField
        label="Id"
