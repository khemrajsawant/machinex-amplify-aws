...
import { createGeneralWorkDetails } from "./graphql/mutations";
const client = generateClient();
export default function GeneralWorkDetailsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setMisc_Work(initialValues.Misc_Work);
    setHrs(initialValues.Hrs);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createGeneralWorkDetails.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "GeneralWorkDetailsCreateForm")}
      {...rest}
    >
      <TextField
        label="Id"
