...
import { createWorkOrderOpeationwiseSpliup } from "./graphql/mutations";
const client = generateClient();
export default function WorkOrderOpeationwiseSpliupCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createWorkOrderOpeationwiseSpliup.replaceAll(
              "__typename",
              ""
            ),
            variables: {
      ...
      {...getOverrideProps(overrides, "WorkOrderOpeationwiseSpliupCreateForm")}
      {...rest}
    >
      <TextField
        label="Id"
